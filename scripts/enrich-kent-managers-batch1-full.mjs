// scripts/enrich-kent-managers-batch1-full.mjs
//
// Full run: same crawl/extraction logic as the test batch (ranked candidate
// pages, wide hints, guessed-path fallback, multi-page concatenation),
// applied to all remaining Kent schools that have a website and haven't
// already been processed in the 20-school test batch.
//
// Safe to re-run: only pulls rows where business_manager_name is still
// null and website_status isn't already 'checked_not_found', so a
...
// The 20 URNs already processed in the test batch — excluded so we don't
// waste API calls re-checking them. The 8 found already have data; the
// other 12 (11 not_found + 1 site_unreachable) are left as-is rather than
// re-attempted automatically, since they were tried with the same logic
// this script uses.
const ALREADY_PROCESSED_URNS = [
  118254, 118255, 118257, 118258, 118262, 118264, 118266, 118271, 118272,
  118273, 118277, 118278, 118279, 118280, 118282, 118283, 118285, 118286,
  118288, 118289,
];
